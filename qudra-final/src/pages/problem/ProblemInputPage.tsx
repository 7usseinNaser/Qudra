...
export function ProblemInputPage() {
  ...
  const handleAnalyze = useCallback(async () => {
    ...
    // إنشاء المشكلة على الباك إند الحقيقي (لا يوقف التدفق إذا فشل)
    try {
      ...
      // فشل الإنشاء لا يوقف رحلة المستخدم — البيانات محفوظة محلياً
    }
  ...
  }, [inputText, navigate, setProblemText]) // eslint-disable-line react-hooks/exhaustive-deps
